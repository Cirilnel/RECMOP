...
def _trova_file_in_regione(regione: str, extension: str) -> str:
    """
...
def _trova_dbf_in_regione(regione: str) -> str:
    """
    ...
    """
    return _trova_file_in_regione(regione, ".dbf")

def _trova_shp_in_regione(regione: str) -> str:
    """
    ...
    """
    return _trova_file_in_regione(regione, ".shp")

def _salva_dati_basi_territoriali(df: pd.DataFrame, cartella_output: str, nome_file: str,
...
def _estrai_dati_basi_territoriali(percorso_file: str) -> pd.DataFrame:
    """
...
def run_estrazione_basi_territoriali(regione: str) -> pd.DataFrame:
    ...
    input_path = _trova_dbf_in_regione(regione_safe)
    nome_file = f"basi_territoriali_{regione_safe}.csv"
    df = _estrai_dati_basi_territoriali(input_path)
    _salva_dati_basi_territoriali(df, OUTPUT_DIR, nome_file)
    return df
...
def get_geom_basi_territoriali(regione: str) -> gpd.GeoDataFrame:
    ...
    """
    regione_safe = safe_name(regione)
    percorso_shp = _trova_shp_in_regione(regione_safe)
